...
async def admin_start_scan(request: Request, url: str = Form(""), scan_type: str = Form("manual"), source: str = Form("web"), force_rescan: bool = Form(False), session_token: str = Cookie(None)):
